...
<head>
    <title>{{ config('app.name', 'Dorepha & Maesta') }} - Edit User </title>
    ...
    <div class="the-table-content-1 my-0 d-block overflow-auto pb-5 mb-5">
        ...
        <div class="container-fluid">
            ...
            <div class="row div_container_user justify-content-center">
                <div class="col-sm-6">
                    <div class="h4 mb-3">Edit User info</div>
                    <form method="post" action="/update_user" id="user_edit_form">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="email" class="form-control @error('email')is-invalid @enderror"
                                    name="email" id="email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$"
                                    value="{{ $errors->has('email') ? old('email') : $data->email }}" required
                            ...
                            <div class="form-group col-12">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control @error('password')is-invalid @enderror"
                                        ...
                                        value="@error('email'){{ old('password') }} @enderror" @if ($errors->has('email') || $errors->has('name')) @else
                                           pattern="^(?=.*?[a-z])(?=.*?[0-9]).{7,}$" @endif
                                        ...
                                        <span class="invalid-feedback" role="alert">
                                            @if ($message == 'The password format is invalid.')
                                                ...
                                                <p id="passwordHelpBlock" class="form-text text-muted">
                                                    Your password must be contain at least one number and lowercase letter,
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href="/user_management"><button type="button"
                                        class="btn btn-secondary w-100">Back</button></a>
                            </div>
                            <div class="col-6">
